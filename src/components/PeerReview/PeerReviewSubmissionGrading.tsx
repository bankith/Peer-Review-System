...
const PeerReviewSubmissionGrading = ({ peerReview, peerReviewSubmission, comments, reviewrNumber, isAnswerSectionEnable = true, reviwerName, reviwerGroupName, isReviewee }: PeerReviewSubmissionGradingProps) => {  
    ...
    <>     
      <div className="bg-white px-6 py-5 mt-6 shadow dark:bg-dark-1 rounded-lg">
        ...
        <div className="col-span-4">
          ...
          {comments.length == 0 && isReviewee ? <div>Waiting for the grading</div> :
          <>
          ...
          {(peerReviewSubmission && isAnswerSectionEnable) ? <AnswerCommentSection peerReviewSubmission={peerReviewSubmission} canScore={comments.length == 0 ? true : false} isGrading={true} /> : null}
          </>
          }
        </div>
